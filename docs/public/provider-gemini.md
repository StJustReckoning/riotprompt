...
This guide shows how to use RiotPrompt with Google Gemini models (Gemini 2.0 Flash, Gemini 1.5 Pro, Gemini 1.5 Flash, etc.).
...
RiotPrompt automatically maps Gemini model names to the correct system role:

| Model | System Role | Notes |
|-------|-------------|-------|
| `gemini-2.0-flash` | `system` | Latest Flash model |
| `gemini-2.0-flash-latest` | `system` | Latest version alias |
| `gemini-1.5-pro` | `system` | Most capable Gemini 1.5 |
| `gemini-1.5-flash` | `system` | Fast and affordable |
| `gemini-1.5-flash-8b` | `system` | Smallest variant |
